...
export const SEED_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    rating: 4.8,
    reviewCount: 3420,
    pros: ["Blazing performance out of the box", "Free hands-on migrations by Kinsta engineers", "Daily backups with one-click restore"],
  ...
  },
  {
    ...
    rating: 4.3,
    reviewCount: 4110,
    pros: ["One-click upsells that lift average order value", "Everything a funnel needs in one tool", "Massive template library"],
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 15400,
    pros: ["Flexible enough for any workflow", "Generous free tier to start on", "Best template ecosystem"],
